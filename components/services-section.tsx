...
const individualServices = [
  {
    ...
    id: "windows-tuning",
    price: "25",
    description: "Custom OS and complete Windows tuning to maximize performance and stability for an unreal gaming experience. Configuring dxgkrnl and kernel settings through the registry, stripping unnecessary scheduled tasks, services, and devices for deep, surface-level optimization.",
  },
  {
    icon: Cpu,
