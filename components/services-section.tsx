...
const individualServices = [
  {
    ...
    id: "windows-tuning",
    price: "10",
    description: "Complete Windows optimization with registry tweaks, service configuration, and bloatware removal.",
  },
  {
    icon: Cpu,
    title: "GPU OC",
    id: "gpu-oc",
    price: "15",
    description: "Professional GPU overclocking for maximum graphics performance and stability.",
  },
  {
    icon: MemoryStick,
    title: "RAM OC (DDR5)",
    id: "ram-oc-ddr5",
    price: "50",
    description: "DDR5 memory overclocking with XMP profiles and manual timing optimization.",
  },
  {
    icon: MemoryStick,
    title: "RAM OC (DDR4)",
    id: "ram-oc-ddr4",
    price: "40",
    description: "DDR4 memory overclocking with custom timings and stability testing.",
  },
  {
    icon: Gauge,
    title: "CPU OC",
    id: "cpu-oc",
    price: "25",
    description: "CPU overclocking with voltage optimization and thermal management.",
  },
  {
    icon: Wifi,
    ...
    id: "network-tuning",
    price: "10",
    description: "Network stack optimization for reduced ping and packet loss.",
  },
  {
    icon: HardDrive,
    title: "BIOS Tuning",
    id: "bios-tuning",
    price: "12",
    description: "BIOS configuration for optimal system performance and stability.",
  },
];
...
const packages = [
  ...
  },
  {
    ...
    price: "45",
    tier: "entry",
    includes: ["Windows Tuning", "BIOS Tuning", "GPU OC"],
  ...
  },
  {
    ...
    price: "52",
    tier: "high-entry",
    includes: ["Windows Tuning", "BIOS Tuning", "CPU OC"],
  ...
  },
  {
    ...
    price: "65",
    tier: "pro",
    includes: ["Windows Tuning", "BIOS Tuning", "CPU OC", "GPU OC"],
    popular: true,
  ...
  },
  {
    ...
    price: "90",
    tier: "extreme",
    includes: ["Windows Tuning", "BIOS Tuning", "CPU OC", "GPU OC", "RAM OC"],
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            From BIOS tuning to network optimization, we cover every aspect of your system 
