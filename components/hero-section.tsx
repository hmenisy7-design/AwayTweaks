    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          >
            <span className="gradient-text glow-text">Unlock.</span>
            <br />
            <span className="gradient-text glow-text">Optimize.</span>
            <br />
            <span className="gradient-text glow-text">Dominate.</span>
          </motion.h1>
          ...
          >
            Professional PC optimization services that deliver measurable results. 
            Boost your FPS, reduce latency, and unlock your system&apos;s true potential.
          </motion.p>
          ...
          >
            <div className="glass rounded-xl p-6 border border-border hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-2xl font-bold text-foreground">-64%</h3>
