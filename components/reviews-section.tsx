...
const allReviews = [
  ...
  },
  {
    name: "edu246_",
    game: "Various Titles",
    content: "i mean my ram oc just got better, +200mt/s and lower timings so better perf, bigger vouch to Away tbh. Went from 200fps unstable (drops everytime to 190 - 180) to more than 250fps stable",
    rating: 5,
  },
  {
    name: "georgejadon",
    game: "General Use",
    content: "I recently had my PC tweaked by Away, and I'm genuinely impressed with the results. Everything feels noticeably smoother, faster, and way more responsive. He optimized the system properly instead of just doing basic, surface-level changes. Load times improved, overall performance feels more stable, and even general use is smoother. Solid and reliable work.",
    rating: 5,
  },
  {
    name: "jayzaloner",
  ...
  },
  {
    ...
    content: "I gotta say Away might be the best pc optimizer. He singlehandedly reached out to me to let me know my OS and OC's could both be messed up. He didn't even try to sell me anything at first, just fixed my overclocks for free. After he showed me what he can do I paid for full service and bro this is the best my pc has ever ran. Holy goat.",
    rating: 5,
  },
  {
    name: "erlamaverde",
    game: "RAM Overclocking",
    content: "I was dealing with problems with stability and game crashes. Since I have Samsung D-die RAM I couldn't find the right profile, so I went to Away and he found a fully stable profile without losing performance. We kept it at 3200MHz and he fixed everything in just a few hours.",
    rating: 5,
  },
  {
    name: "vgqm",
...
function ReviewCard({ review }: { review: typeof allReviews[0] }) {
  return (
    <div className="glass rounded-2xl p-6 border border-border hover:border-primary/50 transition-colors duration-300 w-80 flex-shrink-0 mx-3">
